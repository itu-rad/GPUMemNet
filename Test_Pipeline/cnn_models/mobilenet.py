...
def train_mobilenet(batch_size, num_epochs=10, learning_rate=0.001, data_dir='/raid/datasets/imagenet'):
    # Define transformations
    transform = transforms.Compose([
        transforms.Resize(256),  # MobileNet requires 224x224 input size
    ...
    model = torchvision.models.mobilenet_v2(weights=None, num_classes=1000)
