...
def train_resnet50(batch_size, num_epochs=10, learning_rate=0.001, data_dir='/raid/datasets/imagenet', meta_cache_dir='/home/ehyo/.torch_cache/imagenet_meta'):
    ...
    model.fc = nn.Linear(model.fc.in_features, 1000)  # Adjust for ImageNet classes
