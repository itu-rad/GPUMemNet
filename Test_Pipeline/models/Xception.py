...
def train_xception(batch_size, num_epochs=10, learning_rate=0.001, data_dir='/raid/datasets/imagenet', meta_cache_dir='/home/ehyo/.torch_cache/imagenet_meta'):
