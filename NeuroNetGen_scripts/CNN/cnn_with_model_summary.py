...
if __name__ == '__main__':
    ...
    mock_input = torch.randn(args.batch_size, args.channels, *input_size_tuple).to(device)  # Mock input for summary
    summary(model, mock_input, show_input=True, show_hierarchical=True)  # Call modelsummary
