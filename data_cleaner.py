...
def extract_model_info(out_file):
    ...
    return activations_params, depth, total_params, total_activations
...
def process_dataset(dataset_dir, output_csv):
    with open(output_csv, mode='w', newline='') as csv_file:
        fieldnames = ['Filename', 'Depth', 'Activations-Params', 'Total Activations', 'Total Parameters', 'Batch Size', 
        ...
        for root, dirs, files in os.walk(dataset_dir):
            for file in files:
                if file.endswith('.out'):
                    ...
                    activations_params, depth, total_params, total_activations = extract_model_info(out_file_path)
...
if __name__ == "__main__":
    dataset_directory = "dataset"  # Replace with the actual dataset directory path
    output_csv_path = "output_data.csv"  # Specify the desired output CSV file
