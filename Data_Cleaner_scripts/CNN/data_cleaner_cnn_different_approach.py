        ...
        for line in lines:
            ...
            if "Conv2d-" in line:
                ...
                if output_shape and param_count:
                    ...
                    activations_params.append(('conv2d', channels, height, width, batch_size, params))
                    total_params += params
            ...
            # Handle BatchNorm2d layers
                ...
                if output_shape and param_count:
                    ...
                    activations_params.append(('batchnorm2d',  channels, height, width, batch_size, params))
                    total_params += params
                    total_activations += activations
                else:
            ...
            # Handle Dropout layers
                ...
                if output_shape:
                    ...
                    activations_params.append(('dropout', channels, height, width, batch_size, 0))
                    total_activations += activations
            ...
            # Handle AdaptiveAvgPool2d layers, including small output shapes like [1,1]
                ...
                if output_shape:
                    ...
                    activations_params.append(('adaptive_avg_pool2d', 0, 0, channels, batch_size, 0))
            ...
            # Handle Linear layers
                ...
                if output_shape and param_count:
                    ...
                    activations_params.append(('linear', 0, 0, activations, batch_size, params))
                    # print(line, activations, params, f"{height}, {width}, {channels}")
            ...
            # Handle Softmax layers
                ...
                if output_shape:
                    ...
                    activations_params.append(('softmax', 0, 0, activations, batch_size, 0))
                    total_activations += activations
                else:
            ...
            # Dynamically handle activation functions by identifying any name with common patterns
                ...
                if output_shape:
                    ...
                    activations_params.append((activation_func, channels, height, width, batch_size, 0))
                    total_activations += activations
...
if __name__ == "__main__":
    ...
    output_csv_path = "cnn_data_new_approach.csv"  # Specify the desired output CSV file
